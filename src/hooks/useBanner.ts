...
import {
  ImgBanner,
  BannerOperationType,
} from "../type/typeHooks/typesUseBanner";
...
export const useBannerOperation = (): BannerOperationType => {
  ...
  const arrImgBanner: ImgBanner = [
    {
      src: "https://raw.githubusercontent.com/KutuzovSergey/images/main/baner_1.jpg",
      alt: "baner",
      id: 0,
    },
    {
      src: "https://raw.githubusercontent.com/KutuzovSergey/images/main/baner_2.jpg",
      alt: "baner",
      id: 1,
    },
    {
      src: "https://raw.githubusercontent.com/KutuzovSergey/images/main/baner_3.jpg",
      alt: "baner",
      id: 2,
    },
    {
      src: "https://raw.githubusercontent.com/KutuzovSergey/images/main/baner_4.jpg",
      alt: "baner",
      id: 3,
    },
    {
      src: "https://raw.githubusercontent.com/KutuzovSergey/images/main/baner_5.jpg",
      alt: "baner",
      id: 4,
    },
  ];
  ...
  return [bannerActive, dataBanner, loadedImg, switchSlide, getLoadedImg]
};

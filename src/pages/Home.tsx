...
const Home: FC = () => {
  const modalLogin: boolean = useSelector(
    (state: RootState) => state.generalApp.modalLogin
  );
  const modalRegistr: boolean = useSelector(
    (state: RootState) => state.generalApp.modalRegistr
  );
